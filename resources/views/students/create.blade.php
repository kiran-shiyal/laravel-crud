...
@section('content')
    ...
    <div class="container-sm  d-flex justify-content-center align-items-center " style="height: 100vh;">
        ...
        <form method="POST" action="{{ route('students.store') }}" style="max-height:590px" enctype="multipart/form-data"
            ...
            <div class="form border border-1  p-3 rounded-2" style="background-color: rgb(240, 241, 236);">
                ...
                <div class="row " style="row-gap: 17px;">
                    ...
                    <div class="col-sm-6 ">
                        ...
                        <span class="text-danger" id="fnameErr">
                            @error('firstName')
                                {{ $message }}
                            @enderror
                        </span>
                ...
                <div class="row mt-3" style="row-gap: 17px;">
                    <div class="col-sm-6">
                        ...
                        <span class="text-danger text-sm" id="emailErr"> @error('email')
                                {{ $message }}
                            @enderror
                        </span>
                    </div>
                    <div class=" col-sm-6">
                        ...
                        <span class="text-danger text-sm" id="passwordErr"> @error('password')
                                {{ $message }}
                            @enderror
                        </span>
                    </div>
                ...
                <div class="row mt-3" style="row-gap: 17px;">
                    ...
                    <div class="col-sm-6" style="row-gap: 17px;">
                        ...
                        <span class="text-danger" id ="genderErr"> @error('gender')
                                {{ $message }}
                            @enderror
                        </span>
                    </div>
                ...
                <div class="row mt-2" style="row-gap: 17px;">
                    ...
                    <div class="col-sm-6">
                        ...
                        <span class="text-danger text-sm" id="dateErr"> @error('dob')
                                {{ $message }}
                            @enderror
                        </span>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <span class="text-danger " id="numberErr"> @error('number')
                                {{ $message }}
                            @enderror
                        </span>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        ...
                        <span class="text-danger text-sm" id="fileErr"> @error('file')
                                {{ $message }}
                            @enderror
                        </span>
                    </div>
